export const content = {
  es: {
    ...
    hero: {
      ...
      socialProof: "Atención VIP en New Farm, Paddington, West End, Ascot, South Brisbane & Indooroopilly",
      rating: "5.0/5 ★ Calificación de Padres en Brisbane",
      mockup: {
    ...
    difference: {
      tag: "POR QUÉ ELEGIR NANNYPRO AI",
